...
export function ThemeToggleButton() {
  ...
  if (!mounted) {
    ...
    return (
      <Button
        variant="ghost"
        size="icon"
        className="w-9 h-9 opacity-0 hover:opacity-100 hover:bg-muted/50 cursor-default"
        aria-hidden="true"
      />
    );
  }
  ...
  return (
    <Button
      ...
      className="w-9 h-9 transition-colors duration-200 hover:bg-muted/50 focus-visible:ring-ring focus-visible:ring-2 focus-visible:ring-offset-2"
    >
