...
export function ThemeToggleButton() {
  ...
  return (
    <Button
      ...
      className="w-9 h-9 transition-colors duration-200 hover:bg-secondary hover:text-foreground focus-visible:ring-ring focus-visible:ring-2 focus-visible:ring-offset-2"
    >
